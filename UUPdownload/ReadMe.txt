...
羊牌 UUP 下载向导（程序名：uupdownload.cmd 和 uupdownload - app.cmd），是基于 uupdump 下载脚本设计开发的 uup 文件下载专用工具。
通过填写 UUP ID 进行 UUP 文件的下载。此向导同时提供“仅下载”和“下载并转换”2 个版本。“下载并转换”版本支持下载后自动转制 ISO。

===============================================================================
使用方式（传统版本，uupdownload.cmd）
===============================================================================
...
===============================================================================
下载协同版（Team）（仅限传统版本 uupdownload.cmd）
===============================================================================
...
Build 19100.1008~Build 19100.1086
选择其中的一个之后，将直接开始下载。
...
===============================================================================
下载 Server 的 UUP 文件（仅限传统版本 uupdownload.cmd）
===============================================================================
