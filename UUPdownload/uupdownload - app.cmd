...
title %title1%%title3% %DispVersion% - %Purpose%
...
:second
cls
title %title1%%title3% %DispVersion% - %Purpose% - %SelectPlat%
...
:clientlang
cls
title %title1%%title3% %DispVersion% - %Purpose% - %SelectClientLang%
...
cls
title %title1%%title3% %DispVersion% - %Purpose% - %SelectSKUGroup%
...
:unsupportclientlang
cls
title %title1%%title3% %DispVersion% - %Purpose% - %UnsupportedLang%
color f4
echo.%line%
echo.%WarTitle%
echo.%line%
...
:setupdateid
cls
title %title1%%title3% %DispVersion% - %Purpose% - %WriteBuildID%
