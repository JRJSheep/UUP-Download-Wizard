...
set "LangDes=Choose the language version of your operating system on this page. Valid range: Core, CoreN, CoreCountrySpecific, &echo Professional, Team. This program only supports Team Edition, version 2004 and above.  &echo If you want to download Windows 10X direct, Enter 39 and press Enter to continnue."
...
set "prod64=，Production，64-bit Edition"
set "test64=，test，64-bit Edition"
set "prodarm64=，Production，arm64-bit Edition"
set "testarm64=，test，arm64-bit Edition"
...
set "WelDes=此页设置用于控制是否启用吊销服务器检测。选择默认设置将会启用吊销服务器检测；选择备用设置 & echo 将会禁用吊销服务器检测。如果你在下载 UUP 文件时遇到吊销服务器检测问题，则可使用选项 2，你 & echo 也可以将选项 2 作为保险选项使用。"
set "Def=默认设置"
set "Alter=备用设置"
set "WizInfo=关于此向导工具："
set "WizVer=版本"
...
set "LangDes=此页选择你使用的操作系统语言版本。有效范围：家庭版及其 N 版、专业版及其 N 版、家庭中文版、&echo 协同版。仅支持版本 2004 及以上版本的协同版。&echo 若要直接下载 Windows 10X，请输入 39 并按“Enter”键。
...
set "prod64=，Production，64-位版本"
set "test64=，test，64-位版本"
set "prodarm64=，Production，arm64-位版本"
set "testarm64=，test，arm64-位版本"
