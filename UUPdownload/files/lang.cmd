...
set "LangDes=Choose the language version of your operating system on this page. Valid range: Home, Home China, Professional, & echo Team. This program only supports Team Edition of version 2004 and above. If you want to download Windows 10X direct, &echo Enter 39 and press Enter to continnue."
...
set "LangDes=此页选择你使用的操作系统语言版本。有效范围：家庭版及其 N 版、专业版及其 N 版、家庭中文版、&echo 协同版。仅支持版本 2004 及以上版本的协同版。若要直接开始下载 Windows 10X，请输入 39 并按“&echo Enter”键继续。"
...
set "TeamDev=协同版 ^(Dev 渠道，Build 20211 及以上，以及版本 20H2 Build 19042.572 以上版本^)"
