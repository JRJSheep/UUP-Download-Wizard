...
echo %line%
set /p choosemenu=%ContExit%
if %choosemenu% equ 1 goto :chooselang
...
echo %UPDScript%
echo %line%
"%aria2%" --no-conf %cert%--log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://www.uupdump.net/get.php?id=%id%&pack=%Lang%&edition=%SKU%&aria2=2"
