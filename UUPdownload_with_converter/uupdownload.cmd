...
:first
cls
del /s /q files\aria2_script.*.txt
...
echo.
echo.以下为 Windows 11 的新增语言选项：
echo.-----------------------------------------------------------------------------------------------
echo. 39 - %LangMenu39% ^| 40 - %LangMenu40% ^| 41 - %LangMenu41%
echo. 42 - %LangMenu42% ^| 43 - %LangMenu43% ^| 44 - %LangMenu44%
echo.
echo.%line%
set /p Lang=%TxtDes1%
...
echo.
echo.%line%
choice /c 12E /n /m "%ContExit%"
if errorlevel 3 goto :EOF
if errorlevel 2 color f0 & goto :chooseclienteditiongroup
if errorlevel 1 color f0 & goto :chooseclientedition
...
choice /c 12E /n /m "%ContExit%"
if errorlevel 3 goto :EOF
if errorlevel 2 color f0 & goto :chooseservereditiongroup
if errorlevel 1 color f0 & goto :chooseserveredition
...
echo. 24 - 19100.1065 ^| 25 - 19100.1066 ^| 26 - 19100.1067 ^| 26 - 19100.1070 ^|
echo.
echo.%line3%
echo.
echo.%TeamSVC%
